...
public class Processor {
	...
	Cache L1i_cache;	// defining L1i and L2d cache
	Cache L1d_cache;
	...
	public Processor()
	{
		...
		L1i_cache = new Cache(this, 128, 8);	// (size, latency) vary them for graphs
		L1d_cache = new Cache(this, 128, 8);	// (size, latency) vary them for graphs
	}
	...
	//returning cache if called
	public Cache getL1iCache() { return L1i_cache; }

	public Cache getL1dCache() { return L1d_cache; }
